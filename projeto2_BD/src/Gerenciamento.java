...
public class Gerenciamento {
    ...
    public void exibirTurma(Disciplina disciplina){
        String sql = "SELECT ad.aluno_matr,a.nome,ad.nota,ad.frequencia FROM aluno_disciplina ad JOIN aluno a ON ad.aluno_matr=a.matricula  WHERE ad.disciplina_cod=? AND ad.periodo=? ";
        ResultSet rs=null;
        try {
            conexao = Conexao.conector();
            pstm = conexao.prepareStatement(sql);
