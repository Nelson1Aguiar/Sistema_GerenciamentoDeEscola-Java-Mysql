...
public class Gerenciamento {
                ...
                switch (op) {
                    ...
                    case 4:
                        ...
                        for (Estudante e : getEstudantes()) {
                            ...
                            System.out.println("Distincao: "+e.getDistincao());
                            if (e.isSexo() == true) {
                    ...
                    case 7:
                        ...
                        for (Estudante e : getEstudantes()) {
                                SimpleDateFormat dataFormatar = new SimpleDateFormat("dd/MM/yyyy ");
                                String dataFormatada = dataFormatar.format(e.getNascimento());
                                if (e.getNome().toLowerCase().contains(aux.toLowerCase()) ||e.getEmail().toLowerCase().contains(aux.toLowerCase()) ) {
                                    System.out.println("Matricula: " + e.getMatricula());
                                    System.out.println("Nome: " + e.getNome());
                                    System.out.println("Email: " + e.getEmail());
                                    System.out.println("Telefone: " + e.getTelefone());
                    ...
                    case 8:
                        ...
                        updateEstudanteDisciplina(estudante,disciplina);

                        System.out.println("Resultado do aluno foi atualizado!");
                    ...
                    case 9:
                        ...
                        System.out.println("Digite o periodo da  (Ex: 2021.1): ");
                        disciplina.setPeriodo(scan.nextLine());
                        deleteEstudanteDisciplina(estudante,disciplina);
                        System.out.println("Resultado do aluno foi excluido!");
                        break;
                    default:
            ...
            if(opPrincipal==2){
                ...
                switch (op) {
                    ...
                    case 6:
                        ...
                        for (Disciplina d : getTurmas()) {
                            System.out.println("Nome: " + d.getNome());
                            System.out.println("Periodo: " + d.getPeriodo());
                            System.out.println("Numero de estudantes: " + d.getQtdEstudante());
                            System.out.println("Maior nota: " + d.getMaiorNota());
                            System.out.println("Menor nota: " + d.getMenorNota());
                            System.out.println("Media da turma: " + d.getMediaNotas());
                            System.out.println("\n");
                        }
                        break;
    ...
    public List<Estudante> getEstudantes(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                est.setMedia(rs.getFloat("media"));
                est.setDistincao(rs.getString("distincao"));
    ...
    public void exibirHistorico(Estudante estudante){
        String sql = "SELECT d.nome,a.disciplina_cod,a.periodo,a.nota,a.frequencia FROM aluno_disciplina a JOIN disciplina d ON a.disciplina_cod = d.codigo WHERE a.aluno_matr =?";
        ResultSet rs=null;
        try {
            conexao = Conexao.conector();
            pstm = conexao.prepareStatement(sql);
    ...
    public void exibirTurma(Disciplina disciplina){
        String sql = "SELECT ad.aluno_matr,a.nome,ad.nota,ad.frequencia FROM aluno_disciplina ad " +
                "JOIN aluno a ON ad.aluno_matr=a.matricula  WHERE ad.disciplina_cod=? AND ad.periodo=? ";
        ResultSet rs=null;
        try {
            conexao = Conexao.conector();
            pstm = conexao.prepareStatement(sql);
            ...
            while (rs.next()) {
                ...
                System.out.println("Nome:" +rs.getString("a.nome"));
    ...
    public List<Disciplina> getTurmas(){
        ...
        try {
            ...
            while (rs.next()) {
                Disciplina dis=new Disciplina();
                dis.setNome(rs.getString("nome"));
                dis.setPeriodo(rs.getString("periodo"));
                dis.setQtdEstudante(rs.getInt("qtdAluno"));
                dis.setMaiorNota(rs.getFloat("maior_nota"));
                dis.setMenorNota(rs.getFloat("menor_nota"));
                dis.setMediaNotas(rs.getFloat("media"));
   ...
   public void updateEstudanteDisciplina(Estudante estudante,Disciplina disciplina){
       String sql = "UPDATE aluno_disciplina SET nota=?,frequencia=? WHERE aluno_matr=? AND disciplina_cod=? AND periodo=?";
       try {
           conexao = Conexao.conector();
           pstm = conexao.prepareStatement(sql);
           pstm.setFloat(1, estudante.getNota());
           pstm.setFloat(2, estudante.getFrequencia());
           pstm.setInt(3, estudante.getMatricula());
           pstm.setInt(4, disciplina.getCodigo());
           pstm.setString(5, disciplina.getPeriodo());
    ...
    public void deleteEstudanteDisciplina(Estudante estudante,Disciplina disciplina){
        String sql = "DELETE FROM aluno_disciplina WHERE aluno_matr=? AND disciplina_cod=? AND periodo=?";
        try {
            conexao = Conexao.conector();
            pstm = conexao.prepareStatement(sql);
            pstm.setInt(1, estudante.getMatricula());
